...
import 'package:x_app/presentation/resources/values_manager.dart';
...
class StateRenderer extends StatelessWidget {
  ...
  StateRenderer(
      {super.key, required this.submissionStatus,
    ...
    switch (submissionStatus) {
      case SubmissionStatus.popupLoadingState:
        return _getPopUpDialog(
            context, [_getAnimatedImage(JsonAssets.loading),_getMessage('Loading ...')]);
